  ...
  <script>
    ...
    function showYoutubeContent() {
        $.ajax({
            ...
            url: "<?php echo base_url('show_youtube_content'); ?>"
        }).done(function (response) {
            $("#profile3").html(response);
        });
    }
    ...
    function showUpcomingContent() {
        $.ajax({
            ...
            url: "<?php echo base_url('show_upcoming_content'); ?>"
        }).done(function (response) {
            $("#profile2").html(response);
        });
    }
